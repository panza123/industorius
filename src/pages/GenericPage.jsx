    ...
    return (
        <main className='w-full h-ful max-auto'>
         ...
         object-cover ' />
          ...
          bg-gradient-to-r from-red-900 to-gray-900 opacity-75 text-center'>
    
            <h1 className="text-6xl text-white pl-3 max-sm:3xl">Generic</h1>
        ...
        <div className='w-[500px]   h-full bg-white   md:w-[70%]  lg:w-[90%]
        rounded-[5px] mt-10
         ...
         '>
          ...
          <div className='px-10 py-10 text-gray-700 :'>
						...
						<p className='pt-3'>In arcu accumsan arcu adipiscing accumsan orci ac. Felis id enim aliquet. Accumsan ac integer lobortis commodo ornare aliquet accumsan erat tempus amet porttitor. Ante commodo blandit adipiscing integer semper orci eget. Faucibus commodo adipiscing mi eu nullam accumsan morbi arcu ornare odio mi adipiscing nascetur lacus ac interdum morbi accumsan vis mi accumsan ac praesent.</p>
						<p className='pt-3'>Felis sagittis eget tempus primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Magna sed etiam ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus lorem ipsum dolor sit amet nullam.</p>
