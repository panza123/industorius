...
export default function Elements() {
  return (
    <main className='w-full h-full  max-auto'>
     ...
     object-cover ' />
      ...
      bg-gradient-to-r from-red-900 to-gray-900 opacity-75 text-center'>
        ...
        <h1 className="text-6xl text-white pl-3 max-sm:3xl">Elements</h1>
    ...
    <div className='w-[400px]  h-full bg-white  md:w-[50%] lg:w-[90%]
    rounded-[5px] mt-10
     ...
     '>
       ...
       <div className='w-full h-full px-[20px] mt-[10px] '>
         ...
         <p className='pt-[10px]'>This is <b>bold</b> and this is <strong>strong</strong>. This is <i>italic</i> and this
									...
									This is <u>underlined</u>, this is <code>code</code>, and this is a <Link className='text-red-700'>link</Link>.</p>
         ...
         <p className='pt-5'>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing gravida odio porttitor sem
